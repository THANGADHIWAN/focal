...
class LegacySampleStatus(str, Enum):
    """Legacy status values for samples in the system"""
    SUBMITTED = "SUBMITTED"
...
class LegacyTestStatus(str, Enum):
    """Legacy status values for tests in the system"""
    PENDING = "PENDING"
